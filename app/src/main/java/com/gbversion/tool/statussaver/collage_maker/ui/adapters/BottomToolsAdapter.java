...
public class BottomToolsAdapter extends RecyclerView.Adapter<BottomToolsAdapter.ViewHolder> {
    ...
    public BottomToolsAdapter() {
        this.mToolList.add(new ToolModel("Crop", R.drawable.ic_new_unpress_crop, EditingToolType.CROP));
        this.mToolList.add(new ToolModel("Adjust", R.drawable.ic_new_unpress_flter, EditingToolType.ADJUST));
...
//        this.mToolList.add(new ToolModel("Text", R.drawable.text_unpress1, EditingToolType.TEXT));
        this.mToolList.add(new ToolModel("Fit", R.drawable.ic_new_unpress_fit, EditingToolType.INSTA));
...
//        this.mToolList.add(new ToolModel("Splash", R.drawable.splash_unpress, EditingToolType.SPLASH));
        this.mToolList.add(new ToolModel("Brush", R.drawable.ic_new_unpress_brush, EditingToolType.BRUSH));
