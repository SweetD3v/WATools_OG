...
public class AspectRatioPreviewAdapter extends RecyclerView.Adapter<AspectRatioPreviewAdapter.ViewHolder> {
    ...
    public AspectRatioPreviewAdapter() {
        ratios = Arrays.asList(new CustomAspectRatio(10, 10, R.drawable.crop_free, R.drawable.crop_free_click, "Free"),
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        viewHolder.txtRatio.setText(customAspectRatio.getRatioText());
